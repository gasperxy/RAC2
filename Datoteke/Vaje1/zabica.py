...
# # vidimo, da gre hitreje, če so vrednosti enake (1), saj tako funkcija izračuna manj skokov
# izmeri_cas3 = True
# if izmeri_cas3 == True:
#     print()
#     print('Enake vrednosti')
#     for n in range(100, 600, 100):
#         testni_primer = generator_testnih_primerov(n, 1)
#         t = izmera_casa(testni_primer)
#         print(f'n = {n}, cas = {t:.6f}s')
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzA4MiwidXNlciI6MzkyOX0:1pd7Mi:BWyh2KbV2sgbM0crDkOhEO5_bw4nHeEb8DmYKUI_Xp0"
        try:
            Check.equal('zabica([2, 4, 1, 2, 1, 3, 1, 1, 5])', 3)
            Check.equal('zabica([4, 1, 8, 2, 11, 1, 1, 1, 1, 1])', 2)
            Check.equal('zabica([1])', 1)
            Check.equal('zabica([2 for _ in range(200)])', 100)
        except:
            Check.error(
    ...
    try:
        ...
        token = "Token c8735e09432b574e3c494dea1f8112511cbd6b72"
