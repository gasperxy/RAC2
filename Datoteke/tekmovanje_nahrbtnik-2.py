...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1MywidXNlciI6NDAyOH0:1pdGKb:OSTMHzwrL3xUFV34YYl6PUvk4PICNnDqeWYWsmDashk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NCwidXNlciI6NDAyOH0:1pdGKb:65x_4SO6NzSJyZNYYJvFQHvvw0C8ZOGQ-4BOkDxzzV0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NSwidXNlciI6NDAyOH0:1pdGKb:jnKwkZ95nnfv7CKYl-2kAkcDl6DGZawXm-a2E67U8Gg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NiwidXNlciI6NDAyOH0:1pdGKb:tgVqOwnljd_gySrRlT_axJ7NEcO92EvAEUNq54KxDA4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NywidXNlciI6NDAyOH0:1pdGKb:YyRVt-Zt_1rhQi7fz7Xc4CHry8gS57kwIVmWnym7mTw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NCwidXNlciI6NDAyOH0:1pdGKb:7PMkSw-MGjcfmSbvRawjYWL7ooxWZ6fLIYkyz8ZE4pM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NSwidXNlciI6NDAyOH0:1pdGKb:7k2WFmKQujOKXzT6JJCY2SJpHDDAAOZZPZtVx19zJTI"
        try:
    ...
    try:
        ...
        token = "Token 96aa09189a41d9af1974f6c5e579632bd28041f3"
