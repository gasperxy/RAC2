...
print(zabica(mocvara1))

mocvara2 = [2,4,6,8,3,4,5,2,3,8]
print(zabica(mocvara2))

mocvara3 = [2, 4, 1, 2, 1, 3, 1, 1, 5]
print(zabica(mocvara3))

mocvara4 = [2,2,2,2,2,2,2,2,2,2]
print(zabica(mocvara4))

mocvara5 = [1,1]
print(zabica(mocvara5))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzA4MiwidXNlciI6NDAyOH0:1pdGtY:JxDxLSrrMB5HJwYyxuX5gC7Y6MzPe-M0hjlhBP3rZb8"
        try:
