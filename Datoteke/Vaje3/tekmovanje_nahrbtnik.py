...
def optimalni_tovor(predmeti, W):
    ...
    def max_cena(i, w):
        ...
        if w < 0: # v nahrbtnik ne moremo dati več kot je volumen
            return float("-inf")
        if i == 0 or w == 0: # zmanjkalo je predmetov
            return 0
        # if w < 0: # v nahrbtnik ne moremo dati več kot je volumen
        #     return float("-inf")
        # else:
        #     return 0 # zmanjkalo je predmetov
        c = predmeti[i-1][0]    
        # Bellmanova enačba
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1MywidXNlciI6NDc1M30:1pcvnd:hLVKuT2xtqbtK-bha5OieUKd_7bmj8QUepzzzskycgg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NCwidXNlciI6NDc1M30:1pcvnd:EIFwUf58NDQ3n8Oraa0Gy8n94aflqLWc7Wsnk86mTNg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NSwidXNlciI6NDc1M30:1pcvnd:ESypVtJfe5d09VNzOgwEPaiCu5tRdutR2aU440crM48"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NiwidXNlciI6NDc1M30:1pcvnd:ZKQUDbnizSplaFn1XW9qEk0x9H7wHz5kbgSXQHg0MR4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NywidXNlciI6NDc1M30:1pcvnd:_EcbslA9uzKxNiYiVG4nCndlQRHJnCXvi30asVSQqpc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NCwidXNlciI6NDc1M30:1pcvnd:wVxDcrIjJBQA6Yl55r5z0QQ4XfkezzXmfmrqbRssDLw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NSwidXNlciI6NDc1M30:1pcvnd:evBCM7TstQSfSoOS74KJ0JqiXkrWZ1Cb2jlbglxynzc"
        try:
    ...
    try:
        ...
        token = "Token 33ae675337df7940c244a85e69b1fb61cb843eb3"
