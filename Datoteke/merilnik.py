...
if __name__ == '__main__':
    #izpisi_case(zabica, test_gen_sez, [n for n in range(1, 30)])
    #izpisi_case(zabica_iterativno, test_gen_sez, [n for n in range(30)])
    narisi_in_pokazi_vec_funkcij([(zabica_iterativno, "purple"), (zabica, "pink")], test_gen_sez, [n for n in range(1, 20)])
