...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1MywidXNlciI6NDc2OX0:1pb2rg:TqCdlAyeCr2Ky268gWEppGjLshv2Lo7g1tViIhZYNnA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NCwidXNlciI6NDc2OX0:1pb2rg:6LPiXA-syXYjVrzFnhhDElkxxDeZtpuRv2sXhOBctZY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NSwidXNlciI6NDc2OX0:1pb2rg:GilEJSOebQmvOBYotYm1U6bugjnlwYpI6AU_t0aqoVM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NiwidXNlciI6NDc2OX0:1pb2rg:QqSXfFm8Xr2Mdaf-F9596Y4rCY2OwaAzOmo9vkgbXtU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NywidXNlciI6NDc2OX0:1pb2rg:LR28VwGd9fT3_pkdLdwYtvDtyvgbGev--d3RZw0p48U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NCwidXNlciI6NDc2OX0:1pb2rg:rHZkBq0i3_vHxtFhNE7LsDKlNxv_qw0fFH8zJRlzquE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NSwidXNlciI6NDc2OX0:1pb2rg:hvu-Z2-TZpv0SthN_wf6lgS9RjbPOzxopSnP5NYc4HU"
        try:
    ...
    try:
        ...
        token = "Token d76260865c2d0b90bd9825ceab4707601a31a660"
