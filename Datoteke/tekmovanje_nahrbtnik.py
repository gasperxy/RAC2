...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1MywidXNlciI6MzkzNX0:1ph44Q:0vM-dMwQgRH5PTwr-iBetQPconh8TK44bzKIfHEkJXY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NCwidXNlciI6MzkzNX0:1ph44Q:zDVCC2u5B3YxWvSWzmuo1OJwZV_fszK8aBWwi_uN7Ew"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NSwidXNlciI6MzkzNX0:1ph44Q:RzySBwc9RPDlK0kNJnUNvltfDjEHpR8GNlJnGjHmfZA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NiwidXNlciI6MzkzNX0:1ph44Q:FDCk2BSFlKjQDi3UV5Nns_ivhqcuyD0wE2RraF32YvA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI1NywidXNlciI6MzkzNX0:1ph44Q:ObnzVOBluxOELNdQ0OekOxuz0n4cbrvW6IiIRP-WDyM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NCwidXNlciI6MzkzNX0:1ph44Q:ZQ7ZtMicSgo9NOXQANGtxjAZcMIpwRZVYCtRIT-rymE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzI4NSwidXNlciI6MzkzNX0:1ph44Q:HS_ehZegkBIDixbmKRIirMTWFmz9KeFQoytbnXOzVaU"
        try:
