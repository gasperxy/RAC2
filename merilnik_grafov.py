#Casovna primerjava med djikstro in BFS-jem
from djikstra import djikstra
from BFS import bfs_iskanje
...
def oceni_potreben_cas_BFS(fun, gen_graf, n, k):
    """ Funkcija oceni potreben čas za izvedbo funkcije `fun` na primerih
    dolžine `n`. Za oceno generira primere primerne dolžine s klicom
    `gen_primerov(n)`, in vzame povprečje časa za `k` primerov. """
...
def primerjaj_case_dveh(fun1, fun2, gen_graf, sez_n, k=5):
    ...
    for el in sez_n:
        ...
        casi2.append(oceni_potreben_cas_BFS(fun2, gen_graf, el, k))
    ...
    plt.plot(sez_n, casi2, label = 'BFS-algoritem') 
...
if __name__ == '__main__':
    print(primerjaj_case_dveh(djikstra, bfs_iskanje, gen_graf, [100,200,300,400,500,600,700], k=5))
